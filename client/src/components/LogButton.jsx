        ...
        <div>
            {
                isAuthenticated ? <button
                    className='mx-4 bg-lightBlue h-12 outline-double rounded-md w-32 ease-in-out text-black duration-300 hover:bg-blue-800 hover:text-darkWhite md:w-36 sm:h-8'
                    onClick={() => logOut()}
                >LogOut</button>
                    : <button
